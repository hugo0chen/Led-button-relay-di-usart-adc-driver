...
void LwIP_Init(void)
{
  ...
  struct ip_addr gw;
  uint8_t macaddress[6]={2,0,0,0xff,0x7a,0x10};
...
#else
//   IP4_ADDR(&ipaddr, 58, 251,168, 93);
	IP4_ADDR(&ipaddr, 192, 168,1, 107);
  IP4_ADDR(&netmask, 255, 255, 255, 0);
  IP4_ADDR(&gw, 192, 168, 1, 1);
	
// #if LCD_USER
//   LCD_ShowString(20, 18*4, "ipaddr :192.168.1.198", LGRAY, BLACK);
//   LCD_ShowString(20, 18*5, "netmask:255.255.255.0", LGRAY, BLACK);	
//   LCD_ShowString(20, 18*6, "gw     :192.168.1.1", LGRAY, BLACK);	
// #endif
